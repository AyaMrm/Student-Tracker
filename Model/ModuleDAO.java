...
public class ModuleDAO {
    ...
    public List<Module> getAllModulesBySpecialite(int idSpecialite) throws SQLException {
        List<Module> modules = new ArrayList<>();
        String sql = "SELECT * FROM modules WHERE idSpecialite = ?";
        
        try (PreparedStatement stmt = connection.prepareStatement(sql)) {
            stmt.setInt(1, idSpecialite);  // On remplace ? par la spécialité passée en paramètre
